        ...
        {CONDITIONS.map((item) => (
          ...
          >
            <Text
              style={[
                styles.chipText,
                selectedCondition === item.value && styles.chipTextActive,
              ]}
            >
              {item.label}
            </Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.bookTitle}>{String(item.title || "")}</Text>

              <Text>{String(item.author || "")}</Text>

              <Text>{String(item.condition || "")}</Text>
